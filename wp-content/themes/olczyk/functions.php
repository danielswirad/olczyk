...
register_nav_menu('gallery',__('Gallery Navigation'));
 
add_theme_support('post-thumbnails');
add_image_size( 'boxNews-thumb', 200, 160, true ); 
add_image_size( 'boxNews-small', null, 75, false ); 
//add_image_size( 'mainNews', 465, 315, true ); // news main image
//add_image_size( 'kadra', 180, 240, true ); // kadra image
	 
function jpeg_quality_callback($arg) { return (int)99; }
